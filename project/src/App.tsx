      ...
      <main className="relative z-10 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600 font-body">Lade Spielplätze...</p>
          </div>
        ) : playgrounds.length === 0 ? (
          <div className="text-center py-12 card-playful p-8">
            <p className="text-gray-600 font-body text-lg">Keine Spielplätze gefunden. Fügen Sie einen hinzu!</p>
          </div>
        ) : (
